-- Seed users with correct existing department names
...
-- HOD users with correct department names
INSERT INTO public.users (id, first_name, last_name, email, role, department, is_active, created_at)
...
INSERT INTO public.users (id, first_name, last_name, email, role, department, is_active, created_at)
SELECT gen_random_uuid(), 'Jennifer', 'Clarke', 'hr-hod@hospital.org', 'HOD', 'HR', true, '2024-02-01T10:00:00Z'
...
INSERT INTO public.users (id, first_name, last_name, email, role, department, is_active, created_at)
SELECT gen_random_uuid(), 'Alex', 'Morgan', 'admin@hospital.org', 'ADMIN', 'IT', true, '2024-01-20T13:00:00Z'
