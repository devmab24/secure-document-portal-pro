-- Fix ID types to match mock data and seed database

-- First, drop and recreate departments table with text ID
...
-- Seed departments with mock data
...
-- Convert user IDs to proper UUIDs by mapping mock IDs
...
-- Insert form fields for templates
INSERT INTO public.form_fields (template_id, label, field_type, required, order_index) VALUES 
('b2b2b2b2-c3c3-d4d4-e5e5-f6f6f6f6f601'::uuid, 'Policy Title', 'text', true, 0),
('b2b2b2b2-c3c3-d4d4-e5e5-f6f6f6f6f601'::uuid, 'Policy Number', 'text', true, 1),
('b2b2b2b2-c3c3-d4d4-e5e5-f6f6f6f6f601'::uuid, 'Effective Date', 'date', true, 2),
('b2b2b2b2-c3c3-d4d4-e5e5-f6f6f6f6f601'::uuid, 'Policy Content', 'richtext', true, 3);
...
('e5e5e5e5-f6f6-1717-2828-393939393906'::uuid, 'a1a1a1a1-b2b2-c3c3-d4d4-e5e5e5e5e501'::uuid, 'view', 'document', 'c3c3c3c3-d4d4-e5e5-f6f6-171717171701'::uuid,
...
('f6f6f6f6-1717-2828-3939-505050505002'::uuid, 'd4d4d4d4-e5e5-f6f6-1717-282828282802'::uuid, 'a1a1a1a1-b2b2-c3c3-d4d4-e5e5e5e5e504'::uuid,
 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==',
 '2025-06-22T09:00:00Z');